...
{
    /// <inheritdoc />
    public partial class InitWithSeededPeriodsAndLeaveTypes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "408aa945-3d84-4421-8342-7269ec64d949", 0, "d49c71ef-2276-4ceb-a872-16260b2c54cf", new DateOnly(1950, 12, 1), "admin@localhost.com", true, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEF9wq70yfH3Mi4FziAmnD4x23lObNT5YtYfarStYj7dmHgPmjo0D34HjOYU953BjEg==", null, false, "41499901-ef3e-4dba-aef7-21d5dab584cd", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Annual Leave", 21 },
                    { 2, "Sick Leave", 5 },
                    { 3, "Parental Leave", 270 },
                    { 4, "Miscellaneous Leave", 5 }
                });

            migrationBuilder.InsertData(
                table: "Periods",
                columns: new[] { "Id", "EndDate", "Name", "StartDate" },
                values: new object[] { 1, new DateOnly(2025, 6, 30), "2024-2025 Period", new DateOnly(2024, 7, 1) });
